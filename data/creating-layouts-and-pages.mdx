...
![](/imgs/chapter4-folders-to-url-segments.avif)
...
![图示展示了如何添加名为 dashboard 的文件夹以创建新路由 '/dashboard'](/imgs/chapter4-static-site-generation.avif)
...
<details>
  ...
  ![](/imgs/chapter4-routing-solution.avif)
...
![](/imgs/chapter-4-shared-layout.avif)

检查一切是否正确运行，保存你的更改并检查你的本地主机。你应该会看到以下内容：

![](/imgs/chapter4-shared-layout-page.avif)
...
![](/imgs/chapter4-partial-rendering-dashboard.avif)
