...
![收入图表显示过去 12 个月的总收入](/imgs/chapter7-recent-revenue.avif)
...
![最新发票组件和收入图表一起显示](/imgs/chapter7-latest-invoices.avif)
...
![仪表板页面，已获取所有数据](/imgs/chapter7-complete-dashboard.avif)
...
![示意图显示按时间顺序进行顺序数据获取和并行数据获取](/imgs/chapter7-sequential-parallel-data-fetching.avif)
