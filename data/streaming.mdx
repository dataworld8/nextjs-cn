...
![](/imgs/chapter9-server-rendering-with-streaming.avif)

通过流式传输，您可以防止慢速数据请求阻塞整个页面。这允许用户在等待所有数据加载之前看到和与页面的某些部分交互，而无需等待在向用户显示任何 UI 之前加载所有数据。

![](/imgs/chapter9-server-rendering-with-streaming-chart.avif)
...
![带有'Loading...'文本的仪表板页面](/imgs/chapter9-loading-page.avif)
...
![带有加载骨架的仪表板页面](/imgs/chapter9-loading-page-with-skeleton.avif)
...
![](/imgs/chapter9-route-group.avif)
...
![](/imgs/chapter9-loading-revenue-chart.avif)
